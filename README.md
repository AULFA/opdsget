...
[![Maven Central](https://img.shields.io/maven-central/v/one.lfa.opdsget/one.lfa.opdsget.svg?style=flat-square)](http://search.maven.org/#search%7Cga%7C1%7Cg%3A%22one.lfa.opdsget%22)
[![Maven Central (snapshot)](https://img.shields.io/nexus/s/https/oss.sonatype.org/one.lfa.opdsget/one.lfa.opdsget.svg?style=flat-square)](https://oss.sonatype.org/content/repositories/snapshots/one/lfa/opdsget/)
[![Codecov](https://img.shields.io/codecov/c/github/AULFA/opdsget.svg?style=flat-square)](https://codecov.io/gh/AULFA/opdsget)
...
| JVM             | Platform | Status |
|-----------------|----------|--------|
| OpenJDK LTS     | Linux    | [![Build (OpenJDK LTS, Linux)](https://img.shields.io/github/workflow/status/AULFA/opdsget/main-openjdk_lts-linux)](https://github.com/AULFA/opdsget/actions?query=workflow%3Amain-openjdk_lts-linux) |
| OpenJDK Current | Linux    | [![Build (OpenJDK Current, Linux)](https://img.shields.io/github/workflow/status/AULFA/opdsget/main-openjdk_current-linux)](https://github.com/AULFA/opdsget/actions?query=workflow%3Amain-openjdk_current-linux)
| OpenJDK Current | Windows  | [![Build (OpenJDK Current, Windows)](https://img.shields.io/github/workflow/status/AULFA/opdsget/main-openjdk_current-windows)](https://github.com/AULFA/opdsget/actions?query=workflow%3Amain-openjdk_current-windows)
